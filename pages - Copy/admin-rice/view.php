...
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มชนิดของข้าว">
            <i class="fas fa-plus"></i> เพิ่มชนิดของข้าว
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อชนิดของข้าว และกด Enter</small>
            </form>
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">ชื่อชนิดของข้าว</th>
                    <th scope="col"></th>
                </tr>
            </thead>
            <tbody>
...
<div id="template" class="d-none">
    <form autocomplete="off">
        <input type="hidden" name="item_rice_id" value="">
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 100px; width: 100px;">ชนิดของข้าว</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_rice_name" name="item_rice_name"
                                required>
                        </td>
                    </tr>
                </tbody>
