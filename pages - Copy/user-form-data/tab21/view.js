$(function () {
        ...
        ShowConfirm({
            ...
            callback: function (rs) {
                if (rs) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "pages/" + PAGE + "/api/edit-tab21.php",
                        dataType: "JSON",
                        ...
                        success: function (res) {
                            ...
                            if (res.status) {
                                UnbindUnload();
                                LinkTo("./?page=" + PAGE + "&home_id=" + res.home_id + "&tab=22");
                            } else {
                                ShowAlert({
                                    html: res.message,
    ...
    $("#btn-add").click(function () {
        ...
        $contents.find('form').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "pages/" + PAGE + "/api/edit-tab21-add.php",
                dataType: "JSON",
    ...
    $(".btn-edit").click(function () {
        ...
        // console.log(data);
        $.each(data.income9_market, function (i, v) {
        ...
        $contents.find('form').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "pages/" + PAGE + "/api/edit-tab21-edit.php",
                dataType: "JSON",
                data: GetFormData(_this),
                contentType: false,
                processData: false,
    ...
    $(".btn-del").click(function () {
        ...
        ShowConfirm({
            ...
            callback: function (rs) {
                if (rs) {
                    ShowLoading();
                    $.post("pages/" + PAGE + "/api/edit-tab21-del.php", {
