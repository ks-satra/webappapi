    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="informant" id="first-scroll">
                <i class="fas fa-folder mr-2"></i> รายได้จากผลิตภัณฑ์แปรรูป/ผลิตภัณฑ์ OTOP/ผลิตภัณฑ์ในชุมชน
            </div>

            <div>
                <?php
                    foreach($ObjData as $key=>$row) {
                        $row["income8_market"] = $DATABASE->QueryObj("SELECT * FROM income8_market WHERE home_id='".$home['home_id']."' AND order_id='".$row["order_id"]."' ");
                ?>
