$(function () {
        ...
        ShowConfirm({
            ...
            callback: function (rs) {
                if (rs) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "pages/" + PAGE + "/api/edit-tab22.php",
                        dataType: "JSON",
                        ...
                        success: function (res) {
                            ...
                            if (res.status) {
                                UnbindUnload();
                                LinkTo("./?page=" + PAGE + "&home_id=" + res.home_id + "&tab=23");
                            } else {
                                ShowAlert({
                                    html: res.message,
    ...
    $("#btn-add").click(function () {
        ...
        ToggleInputNumber($contents.find('#income'), 0);
        ToggleInputNumber($contents.find('#cost'), 0);
        $contents.find('#income, #cost').keyup(function () {
            var income = ToNum($contents.find('#income').val()) * 1;
        ...
        $contents.find('form').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "pages/" + PAGE + "/api/edit-tab22-add.php",
                dataType: "JSON",
    ...
    $(".btn-edit").click(function () {
        ...
        $contents.find('form').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "pages/" + PAGE + "/api/edit-tab22-edit.php",
                dataType: "JSON",
                data: GetFormData(_this),
                contentType: false,
                processData: false,
    ...
    $(".btn-del").click(function () {
        ...
        ShowConfirm({
            ...
            callback: function (rs) {
                if (rs) {
                    ShowLoading();
                    $.post("pages/" + PAGE + "/api/edit-tab22-del.php", {
