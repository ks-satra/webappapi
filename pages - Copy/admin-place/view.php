<?php
    ...
    if( $search!="" ) {
        $condition_search .= " AND (
            ip.item_place_name LIKE '%".$search."%'
        )";
    }
    ...
    $sql = "
        ...
        WHERE 1=1
            ".$condition_search."
        ORDER BY ip.item_place_id DESC
    ";
    $show = $GLOBAL["SHOW"];
...
<div id="content-title">
    ข้อมูลสถานที่ทำงาน/เรียน
</div>
<?php include("pages/tabs-item/view-start.php"); ?>
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มสถานที่ทำงาน/เรียน">
            <i class="fas fa-plus"></i> เพิ่มสถานที่ทำงาน/เรียน
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อสถานที่ทำงาน/เรียน และกด Enter</small>
            </form>
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">ชื่อสถานที่ทำงาน/เรียน</th>
                    <th scope="col"></th>
                </tr>
            </thead>
            <tbody>
...
<div id="template" class="d-none">
    <form autocomplete="off">
        <input type="hidden" name="item_place_id" value="">
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 140px; width: 140px;">สถานที่ทำงาน/เรียน</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_place_name" name="item_place_name"
                                required>
                        </td>
                    </tr>
                </tbody>
