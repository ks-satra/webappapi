...
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มสถานะการทำงาน">
            <i class="fas fa-plus"></i> เพิ่มสถานะการทำงาน
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อสถานะการทำงาน และกด Enter</small>
            </form>
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">ชื่อสถานะการทำงาน</th>
                    <th scope="col"></th>
                </tr>
            </thead>
            <tbody>
...
<div id="template" class="d-none">
    <form autocomplete="off">
        <input type="hidden" name="item_work_id" value="">
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 130px; width: 130px;">สถานะการทำงาน</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_work_name" name="item_work_name"
                                required>
                        </td>
                    </tr>
                </tbody>
