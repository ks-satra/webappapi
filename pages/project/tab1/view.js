$(function () {
    ...
    $(".btn-edit").click(function () {
        ...
        $contents.find("[name='project_name']").val(data.project_name);
        $contents.find("[name='project_name_all']").val(data.project_name_all);
        $contents.find("[name='project_money']").val(data.project_money);
        $contents.find("[name='project_place']").val(data.project_place);
        $contents.find("[name='project_type_id']").val(data.project_type_id);
