<?php
    ...
    if( $search!="" ) {
        $condition_search .= " AND (
            ip.item_education_name LIKE '%".$search."%'
        )";
    }
    ...
    $sql = "
        SELECT
            ip.*
        FROM item_education ip
        WHERE 1=1
            ".$condition_search."
        ORDER BY ip.item_education_id DESC
    ";
    $show = $GLOBAL["SHOW"];
...
<div id="content-title">
    ข้อมูลระดับการศึกษาสูงสุด
</div>
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มระดับการศึกษาสูงสุด">
            <i class="fas fa-plus"></i> เพิ่มระดับการศึกษาสูงสุด
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อระดับการศึกษาสูงสุด และกด Enter</small>
            </form>
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">ชื่อระดับการศึกษาสูงสุด</th>
                    <th scope="col"></th>
                </tr>
            </thead>
            <tbody>
...
<div id="template" class="d-none">
    <form autocomplete="off">
        <input type="hidden" name="item_education_id" value="">
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 150px; width: 150px;">ระดับการศึกษาสูงสุด</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_education_name" name="item_education_name"
                                required>
                        </td>
                    </tr>
                </tbody>
