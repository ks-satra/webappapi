<?php
    ...
    if( $search!="" ) {
        $condition_search .= " AND (
            ip.item_prefix_name LIKE '%".$search."%'
        )";
    }
    ...
    $sql = "
        ...
        WHERE 1=1
            ".$condition_search."
        ORDER BY ip.item_prefix_id DESC
    ";
    $show = $GLOBAL["SHOW"];
...
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มคำนำหน้า">
            <i class="fas fa-plus"></i> เพิ่มคำนำหน้า
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อคำนำหน้า และกด Enter</small>
            </form>
        </div>
...
<div id="template" class="d-none">
    <form autocomplete="off">
        <input type="hidden" name="item_prefix_id" value="">
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 85px; width: 85px;">คำนำหน้า</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_prefix_name" name="item_prefix_name"
                                required>
                        </td>
                    </tr>
                </tbody>
