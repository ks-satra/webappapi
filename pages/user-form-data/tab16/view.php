<?php
    $sql = "
        SELECT 
            i.*,
            ih.item_horticulture_name
        FROM income4 i
            INNER JOIN item_horticulture ih ON ih.item_horticulture_id=i.item_horticulture_id
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="informant" id="first-scroll">
                <i class="fas fa-folder mr-2"></i> รายได้จากการปลูกพืชสวน
            </div>

            <div>
                <?php
                    foreach($ObjData as $key=>$row) {
                        $row["income4_market"] = $DATABASE->QueryObj("SELECT * FROM income4_market WHERE home_id='".$home['home_id']."' AND order_id='".$row["order_id"]."' ");
                ?>
                <table class="table table-bordered table-sm"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="col">ชนิดของพืชสวน</th>
                            <td scope="col">
                                <?php echo $row["item_horticulture_id"]; ?>.
                                <?php echo $row["item_horticulture_name"]; ?>
                            </td>
                        </tr>
                        <tr>
                            <th scope="col">พันธุ์พืช</th>
                            <td scope="col">
                                <?php echo $row["type_cat"]; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th scope="col">รายได้รวมการปลูกพืชสวน</th>
                            <td scope="col">
                                <?php echo number_format($row["income"],0); ?> บาท/ปี
                            </td>
                        </tr>
                        <tr>
                            <th scope="col">ต้นทุนการปลูกพืชสวนโดยรวม</th>
                            <td scope="col">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="p-2" colspan="2">
                            <select class="form-control form-control-sm" id="item_horticulture_id"
                                name="item_horticulture_id" required>
                                <?php
                                    $sql = "SELECT * FROM item_horticulture ORDER BY item_horticulture_id";
                                    $obj = $DATABASE->QueryObj($sql);
                                    foreach($obj as $row) {
                                        echo '<option value="'.$row["item_horticulture_id"].'">'.$row["item_horticulture_id"].'. '.$row["item_horticulture_name"].'</option>';
                                    }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td>พันธุ์พืช</td>
                        <td class="p-2" colspan="2">
                            <input type="text" class="form-control form-control-sm" id="type_cat" name="type_cat">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>ต้นทุนการปลูกพืชสวนโดยรวม</td>
                        <td class="p-2">
