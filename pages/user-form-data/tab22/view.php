    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="informant" id="first-scroll">
                <i class="fas fa-folder mr-2"></i> รายได้จากการค้าขาย/ร้านค้า
            </div>

            <div>
                <?php
                    foreach($ObjData as $key=>$row) {
                        $row["income10_market"] = $DATABASE->QueryObj("SELECT * FROM income10_market WHERE home_id='".$home['home_id']."' AND order_id='".$row["order_id"]."' ");
                ?>
                <table class="table table-bordered table-sm"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="col">ประเภทการค้าขาย/ร้านค้า</th>
                            <td scope="col">
