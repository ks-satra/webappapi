<?php
    ...
    if( $search!="" ) {
        $condition_search .= " AND (
            ip.item_asset_name LIKE '%".$search."%' OR
            ip.unit LIKE '%".$search."%'
        )";
    }
    ...
    $sql = "
        ...
        WHERE 1=1
            ".$condition_search."
        ORDER BY ip.item_asset_id DESC
    ";
    $show = $GLOBAL["SHOW"];
...
<div id="content-body">
    <div class="mb-4">
        <button id="btn-add" class="btn btn-success" title="เพิ่มรายการทรัพย์สิน">
            <i class="fas fa-plus"></i> เพิ่มรายการทรัพย์สิน
        </button>
    </div>
    <div class="row mb-3">
        <div class="col">
            <form id="frm-search" autocomplete="off">
                ...
                <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่อรายการทรัพย์สิน และกด Enter</small>
            </form>
        </div>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">ชื่อรายการทรัพย์สิน</th>
    ...
    <form autocomplete="off">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td class="pt-3" style="min-width: 85px; width: 85px;">รายการทรัพย์สิน</td>
                        <td class="p-2" style="min-width: 200px;">
                            <input type="text" class="form-control" id="item_asset_name" name="item_asset_name"
                                required>
                        </td>
                    </tr>
                    <tr>
                        <td class="pt-3" style="min-width: 150px; width: 150px;">หน่วย</td>
                        <td class="p-2" style="min-width: 200px;">
