$(function () {
    ...
    $("#btn-add").click(function () {
        $title = $('\
			<div style="font-size: 16px;">\
                <i class="fas fa-plus mb-2"></i> เพิ่มอุปกรณ์ใหม่\
			</div>\
		');
        $contents = $('\
			<div>\
        ...
        $contents.find("#imagef").change(function () {
            FileChange(GLOBAL.ALLOW_IMAGE, GLOBAL.ALLOW_SIZE, this, $contents.find("#image"), './files/device/default.png', function () { });
        });
    ...
    $(".btn-edit").click(function () {
        ...
        $title = $('\
			<div style="font-size: 16px;">\
                <i class="fas fa-edit mb-2"></i> แก้ไขอุปกรณ์\
			</div>\
		');
        $contents = $('\
			<div>\
        ...
        $contents.find("[name='device_name']").val(data.device_name);
        $contents.find("[name='device_sum']").val(data.device_sum);
