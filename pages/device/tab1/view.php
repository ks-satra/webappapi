...
?>
<div class="mb-4">
    <button id="btn-add" class="btn btn-success" title="เพิ่มอุปกรณ์ใหม่">
...
<div class="row mb-3">
    <div class="col">
        <form id="frm-search" autocomplete="off">
            ...
            <small class="form-text text-muted mb-3">ค้นหา โดยระบุ ชื่ออุปกรณ์ หรือจำนวน
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center">ชื่ออุปกรณ์</th>
                ...
                foreach($objData as $key=>$row) {
                    echo '
                        <tr data-json="'.htmlspecialchars(json_encode($row)).'">
                            ...
                            <td class="text-center">'.$row["device_sum"].'</td>
            ...
            <form autocomplete="off">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td class="pt-3">ชื่ออุปกรณ์</td>
                                <td class="p-2">
                                    <input type="text" class="form-control" id="device_name" name="device_name" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="pt-3">จำนวน</td>
                                <td class="p-2">
                                    <input type="text" class="form-control" id="device_sum" name="device_sum" required>
                                </td>
                            </tr>
                        </tbody>
                    </table>
